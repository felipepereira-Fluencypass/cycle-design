 ...
 * <ChevronUpIcon size="sm" decorative />
 *
 * // Semântico (requer aria-label)
 * <ChevronUpIcon size="sm" aria-label="descrição do ícone" />
 */
export function ChevronUpIcon(props: IconProps): JSX.Element {
  return (
    <BaseIcon {...props}>
      <path stroke="#181D27" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m18 15-6-6-6 6"/>
    </BaseIcon>
  )
}
