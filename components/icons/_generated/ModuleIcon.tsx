 ...
 * <ModuleIcon size="sm" decorative />
 *
 * // Semântico (requer aria-label)
 * <ModuleIcon size="sm" aria-label="descrição do ícone" />
 */
export function ModuleIcon(props: IconProps): JSX.Element {
  return (
    <BaseIcon {...props}>
      <path stroke="#181D27" strokeWidth="1.5" d="M4.5 3.751h5a.75.75 0 0 1 .75.75v5a.75.75 0 0 1-.75.75h-5a.75.75 0 0 1-.75-.75v-5a.75.75 0 0 1 .75-.75ZM14.5 3.751h5a.75.75 0 0 1 .75.75v5a.75.75 0 0 1-.75.75h-5a.75.75 0 0 1-.75-.75v-5a.75.75 0 0 1 .75-.75ZM4.5 13.751h5a.75.75 0 0 1 .75.75v5a.75.75 0 0 1-.75.75h-5a.75.75 0 0 1-.75-.75v-5a.75.75 0 0 1 .75-.75ZM14.5 13.751h5a.75.75 0 0 1 .75.75v5a.75.75 0 0 1-.75.75h-5a.75.75 0 0 1-.75-.75v-5a.75.75 0 0 1 .75-.75Z"/>
    </BaseIcon>
  )
}
